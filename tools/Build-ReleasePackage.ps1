...
$userGuide = @(
    ...
    '2. 双击 CK免费工具箱.exe。',
    '3. 页面显示“组件缺失”时，点击“安装组件”，工具箱会从当前页面标记的 GitHub 开源仓库下载并校验。',
    '4. 如果 Blender 显示未安装，点击 Blender 环境依赖打开官网下载安装。',
    '5. 选择模型所在目录，点击“扫描模型”。',
    '6. 勾选需要处理的模型，点击“开始渲染”。',
    '7. 点击“打开输出”查看 PNG。',
    '',
    ...
    '2. 组件缺失时点击“安装组件”，工具箱会从已登记的 GitHub 仓库拉取并校验。',
    '3. 点击“检查更新”查询最新提交，发现更新后点击“更新组件”。',
    ...
    '轻量发布包不预装功能组件；首次安装模型组件时会一并配置 Sollumz 和渲染依赖。',
