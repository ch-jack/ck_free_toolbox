...
$userGuide = @(
    ...
    '6. NUI/RPF/载具武器声浪/扫描移除后门/一键清理小哈页面缺少 Python 时，点击“官网”自行安装 Python 3.7+，再点击“选择”指定 python.exe。',
    ...
    'Python 缺失时 NUI/RPF/载具武器声浪/扫描移除后门/一键清理小哈页面会打开 Python 官网，安装后可选择安装目录中的 python.exe。',
    '正式发布包内置“扫描移除后门”和“一键清理小哈”；模型、NUI、RPF、载具武器声浪、服务器 Dump 和 FXAP 组件按需安装。',
